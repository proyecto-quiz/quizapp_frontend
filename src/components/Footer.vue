...
.footer__links {
  @apply flex w-auto justify-between;
}

.footer__term-pol {
  @apply flex justify-between border-t border-t-primary-dark/40 py-7 dark:border-t-secondary-light/40;
}
</style>
